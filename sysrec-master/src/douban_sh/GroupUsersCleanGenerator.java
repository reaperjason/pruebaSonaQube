...
class GroupUsersCleanGenerator {
    ...
    String groupidUsersPath = "data/groupid_users.dat";
    String groupidUsersClenaPath = "data/groupid_users_clean.dat";
    ...
    public void writeGroupUserCleanFile() {
        System.out.println("Writting in groupid_users_clean.dat...");
        ...
        try {    
            ...
            while (doc.hasNextLine()) {
                ...
                if (!existeIdGroup(Integer.parseInt(columns[0]), groupIdList)) {
                    ...
                    writeFile(line, groupidUsersClenaPath);
                }
            }
        } catch (Exception e) {
